...
export class Renderer {
    constructor() {
        ...
        this._roles.set(UnitRole['Troops'], document.getElementById('role_tr'));
        this._roles.set(UnitRole['Elites'], document.getElementById('role_el'));
        this._roles.set(UnitRole['Fast Attack'], document.getElementById('role_fa'));
        this._roles.set(UnitRole['Heavy Support'], document.getElementById('role_hs'));
        this._roles.set(UnitRole['Flyer'], document.getElementById('role_fl'));
        this._roles.set(UnitRole['Dedicated Transport'], document.getElementById('role_dt'));
        this._roles.set(UnitRole['Fortification'], document.getElementById('role_ft'));
        this._roles.set(UnitRole['Lord of War'], document.getElementById('role_lw'));
    }
    ...
    renderWoundTracker(ctx, unit, columnWidths) {
        const height = 22;
        let w = 50;
    ...
    render(unit, canvas, xOffset, yOffset) {
...
Renderer._res = 144;
Renderer._margin = 0;
Renderer._bevelSize = 15;
Renderer._blackColor = '#1d272a';
Renderer._grey1 = '#b3bbb5';
Renderer._greyLight = '#dde1df';
Renderer._fillColor = '#f6f6f6';
Renderer._unitLabels = ["UNIT", "M", "WS", "BS", "S", "T", "W", "A", "LD", "SAVE"];
Renderer._weaponLabels = ["WEAPONS", "RANGE", "TYPE", "S", "AP", "D", "ABILITIES"];
Renderer._spellLabels = ["PSYCHIC POWER", "MANIFEST", "RANGE", "DETAILS"];
Renderer._explosionLabels = ["EXPLOSION", "DICE ROLL", "DISTANCE", "MORTAL WOUNDS"];
Renderer._trackerLabels = ["WOUND TRACK", "REMAINING W", "ATTRIBUTE", "ATTRIBUTE", "ATTRIBUTE"];
;
