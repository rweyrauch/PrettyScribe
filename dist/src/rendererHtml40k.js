...
exports.RendererHtml40k = void 0;
const roster40k_1 = require("./roster40k");
class RendererHtml40k {
    constructor(roster) {
        this._roster = null;
        this._roster = roster;
    }
    render(title, list, forces) {
        ...
        for (let force of this._roster._forces) {
            ...
            const headerInfo = [{ name: "NAME", width: '20%' }, { name: "ROLE", width: '15%' }, { name: "MODELS", width: '55%' }, { name: "POINTS", width: '5%' }, { name: "POWER", width: '5%' }];
            ...
            for (let unit of force._units) {
                ...
                role.innerHTML = roster40k_1.UnitRoleToString[unit._role];
    ...
    getRoleImage(role) {
        switch (role) {
            case roster40k_1.UnitRole.DT: return "DT";
            case roster40k_1.UnitRole.HQ: return "HQ";
            case roster40k_1.UnitRole.TR: return "TR";
            case roster40k_1.UnitRole.EL: return "EL";
            case roster40k_1.UnitRole.FA: return "FA";
            case roster40k_1.UnitRole.FL: return "FL";
            case roster40k_1.UnitRole.HS: return "HS";
            case roster40k_1.UnitRole.FT: return "FT";
            case roster40k_1.UnitRole.LW: return "LW";
        }
        return "TR";
    }
    renderUnitHtml(unit) {
    ...
    renderNotes(root, title, notes) {
    }
    renderNotesArray(root, title, notes) {
    }
    ...
    renderExplosion(root, explosions) {
    ...
    renderModels(root, models) {
        const labels = [{ name: "No.", width: "3%" }, { name: "Name", width: "22%" }, { name: "M", width: "5%" }, { name: "WS", width: "5%" },
    ...
    renderModelList(root, models) {
    }
    renderAbilities(root, unit) {
    ...
    renderKeywords(root, unit) {
        if (unit._keywords.size > 0) {
            const kwlist = [...unit._keywords];
            kwlist.sort(roster40k_1.Compare);
...
exports.RendererHtml40k = RendererHtml40k;
//# sourceMappingURL=rendererHtml40k.js.map